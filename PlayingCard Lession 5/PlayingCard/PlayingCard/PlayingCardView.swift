...
class PlayingCardView: UIView {
    ...
    var faceCardZcale: CGFloat = SizeRatio.faceCardImageSizeToBoundsSize { didSet {setNeedsDisplay(); setNeedsLayout() }}
    ...
    @objc func adjustFaceCardScale(byHandingGestureRecognizedBy recognizer: UIPinchGestureRecognizer) {
        ...
        case .ended, .changed:
            faceCardZcale *= recognizer.scale
    ...
    override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
        //detect when change size of font in setting of application
        setNeedsDisplay()
        setNeedsLayout()
    }
    ...
    override func draw(_ rect: CGRect) {
        ...
        if isFaceUp {
            if let faceCardImage = UIImage(named: rankString+suit, in: Bundle(for: self.classForCoder), compatibleWith: traitCollection) {
                faceCardImage.draw(in: bounds.zoom(by: faceCardZcale))
            } else {
                //drawPips
                drawPips()
            }
